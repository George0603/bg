 ...
 * communicates with {@code BluetoothService}, which in turn interacts with the
 * Bluetooth LE API.
 */
public class DeviceControlActivity extends BaseActivity {
    ...
    private Handler mHandler = new Handler(){
    	public void handleMessage(android.os.Message msg) {
    		if (msg.what == message) {
    			BluetoothLeService le = mBluetoothLeService; 
    ...
    public void onCreate(Bundle savedInstanceState) {                                        //初始化
        ...
        mHandler.sendEmptyMessageDelayed(message, 1000);  //延迟连接，防止阻塞
    }
